   ...
   private function applyExtraFilters($collection)
{
   ...
   /**
    ...
    /**
     * Returns the vendor's business type label.
     *
     * @param \Magento\Framework\DataObject $item
     * @return string
     */
    public function getBusinessTypeLabel($item)
    {
        $value = trim((string) $item->getData('business_type'));
    ...
    /**
     * Returns the country label for a country code.
     *
    ...
    public function getCountryName($countryCode)
    {
        ...
        try {
            ...
            $name = trim((string) $country->getName());
    ...
    /**
     * Returns a flag image URL for a country code when possible.
     *
     * @param string $countryCode
     * @return string
     */
    public function getCountryFlagUrl($countryCode)
    {
        $countryCode = trim((string) $countryCode);
    ...
    /**
     * Returns a normalized website URL for the vendor.
     *
     * @param \Magento\Framework\DataObject $item
     * @return string
     */
    public function getWebsiteUrl($item)
    {
        $website = trim((string) $item->getData('website'));
