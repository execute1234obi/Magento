    ...
    return Column.extend({
        ...
        getLabel: function (record) {
            ...
            if (value == 0) {
                ...
                statusClass.push('adbooking-approval-notsubmited');
            } else if (value == 1 || value == 4) {
                statusClass.push('label-warning');
                statusClass.push('adbooking-approval-pending');
            } else if (value == 2) {
                statusClass.push('label-success');
                statusClass.push('adbooking-approval-completed');
            } else if (value == 3) {
                statusClass.push('label-danger');
                statusClass.push('adbooking-approval-unapproved');
            }
