...
abstract class AbstractIndex extends \Magento\Framework\Model\AbstractModel
{
    ...
    /**
     * Calculate count of vendor index items cache
     *
     * @return $this
     */
    ...
    /**
     * Retrieve Exclude Vendor Ids List for Collection
     *
     * @return array
     */
     ...
     * @return $this
     */
    public function registerIds($vendorIds)
    {
        $this->_getResource()->registerIds($this, $vendorIds);
