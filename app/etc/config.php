...
return [
    'modules' => [
        ...
        'Business_CustomerFieldofinterest' => 1,
        'Business_MostviewedVendors' => 1,
        'Business_ProductHasprice' => 1,
        'Vnecoms_Core' => 1,
        'Business_VisitorcountryReport' => 1,
        'Vnecoms_Vendors' => 1,
        'Vnecoms_Credit' => 1,
        'Custom_CustomerBusinessCategory' => 0,
        'Custom_HsCode' => 0,
        'Mirasvit_Search' => 1,
        'Custom_VendorList' => 0,
        'Custom_VendorMap' => 1,
        ...
        'Business_VnecomsMembershipPatch' => 0,
        'Vnecoms_VendorsMessage' => 1,
        'Vnecoms_VendorsConfigApproval' => 1,
        'Vnecoms_VendorsNotificationGraphQl' => 1,
        'Vnecoms_VendorsReport' => 1,
        'Vnecoms_VendorsPageBuilder' => 1,
        'Gcc_VendorProductOverride' => 1,
        'Vnecoms_VendorsProductBundle' => 1,
        'Vnecoms_VendorsProductConfigurable' => 1,
        'Vnecoms_VendorsProductDownloadable' => 1,
        'Vnecoms_VendorsProductForm' => 1,
        'Vnecoms_VendorsProductGraphQl' => 1,
        'Vnecoms_VendorsProductGrouped' => 0,
        'Vnecoms_VendorsProductImportExport' => 1,
        'Vnecoms_VendorsProductInventory' => 1,
        'Vnecoms_VendorsProductVideo' => 1,
        'Vnecoms_VendorsProfileNotification' => 1,
        'CustomVendor_HideVnecomsMenu' => 1,
        'Vnecoms_VendorsReportGraphQl' => 1,
        'Vnecoms_VendorsReview' => 1,
        'Vnecoms_VendorsCustomWithdrawal' => 1,
        'Vnecoms_VendorsSalesGraphQl' => 1,
        'Vnecoms_VendorsSalesInventory' => 1,
        'Vnecoms_VendorsSearch' => 1,
        'Vnecoms_VendorsShipping' => 1,
        'Vnecoms_VendorsShippingDHL' => 1,
        'Vnecoms_VendorsShippingFedEx' => 1,
        'Vnecoms_VendorsShippingFlatRate' => 1,
        'Vnecoms_VendorsShippingPickup' => 1,
        'Vnecoms_VendorsShippingUPS' => 1,
        'Vnecoms_VendorsShippingUSPS' => 1,
        'Vnecoms_VendorsSubAccount' => 1,
